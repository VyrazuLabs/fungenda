			...
			<div class="col-lg-12 col-md-12 col-xs-12 footer-details">
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 left-footer-content">
					...
					<ul class="footer-list">
						<li><a href="eventmore.php">Hawali West</a></li>
						<li><a href="eventmore.php">P..F chang's</a></li>
						<li><a href="eventmore.php">2 Alcatraz Tours</a></li>
						<li><a href="eventmore.php">Dave's Test Event 2</a></li>
						<li><a href="eventmore.php">Dave's Test Business 2</a></li>
					</ul>
				</div>
