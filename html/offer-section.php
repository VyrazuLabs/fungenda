...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="offer">
		<p class="text-center offertext">Offer Section</p>
		<p class="text-center offersubtext">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book It has survived not only five</p>
	</div>
</div>
						...
						<div class="customdetail">
							<div class="businessmain businessevent">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
									<button type="button" class="btn view loadmore-btn">Load More <i class="fa fa-angle-down loadmoreicon" aria-hidden="true"></i></button>
					...
					<div class="customdetailright">
						...
						<div class="col-md-12 col-xs-12 righttextimg">
							<div class="col-md-6 col-xs-6 rightimg">
								<a href="shared-location-new.php"><img src="images/right1.png" class="img-responsive"></a>
							</div>
