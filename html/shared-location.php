					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 divca">
							...
							<ul class="cllist">
								<li>Palo Alto</li>
								<ul class="clsublist">
									<li><a href="eventmore.php">Water Slides</a></li>
								</ul>
								<li>Tahoe City</li>
								<ul class="clsublist">
									<li><a href="eventmore.php">Camping by Lake</a></li>
								</ul>
								<li>San Francisco</li>
								<ul class="clsublist">
									<li><a href="eventmore.php">Test public Location 8/9/16</a></li>
								</ul>
								<li>Los Angeles</li>
								<ul class="clsublist">
									<li><a href="eventmore.php">Test Private</a></li>
								</ul>
								<li>San Francisco</li>
								<ul class="clsublist">
									<li><a href="eventmore.php">Halloween Store Test 8/9/16</a></li>
									<li><a href="eventmore.php">Halloween Store</a></li>
									<li><a href="eventmore.php">Rite Aid</a></li>
								</ul>
								<li>Los Gatos</li>
								<ul class="clsublist">
									<li><a href="eventmore.php">Halloween House</a></li>
									<li><a href="eventmore.php">Spectrum Eye Physicians</a></li>
								</ul class="clsublist">
							</ul>
						</div>
