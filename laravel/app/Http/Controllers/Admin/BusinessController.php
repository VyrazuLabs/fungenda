...
class BusinessController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (count($data['business']->getAddress->toArray()) > 0) {
            if (count($data['business']->getAddress->getCountry->toArray()) > 0) {
            ...
            if (count($data['business']->getAddress->getState->toArray()) > 0) {
        ...
        if (count($data['business']->getBusinessOffer->toArray()) > 0) {
