		...
		<div class="main-box">
			...
			<div class="changepwsub-box">
				<div class="changepw-body registration-body">
					<p class="favourite-greeting-text"><span class="favourite-greeting-textfirst">Hi {{ $first_name }}!</span><span class=""> you have successfully added shared</span></p>
					<p class="favourite-greeting-subtext"> location to your favourite list</p>
				...
				<div class="mailer-fabourite-box-div">
					...
					<div class="favourite-image-description-box">
						...
						<p class="image-description-text">{{ $share_location['location_name'] }}</p>
					</div>
				</div>
				<div class="changepw-footer">
					<a href="{{ url('more_shared_location').'/'.$share_location['shared_location_id'] }}"><button type="button" class="mailer-forgetpw-btn">Go to my shared location</button></a>
				</div>
			</div>
		</div>
	</body>
