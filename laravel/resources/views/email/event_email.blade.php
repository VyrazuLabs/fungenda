		...
		<div class="main-box">
			...
			<div class="changepwsub-box">
				<div class="changepw-body registration-body">
					<p class="favourite-greeting-text"><span class="favourite-greeting-textfirst">Hi {{ $first_name }}!</span><span class=""> you have successfully added this event to your favorite list</span></p>
				...
				<div class="changepw-footer">
					<a href="{{ route('frontend_more_event',['q'=>$data['event_id']]) }}"><button type="button" class="mailer-forgetpw-btn">Go to my events</button></a>
				</div>
			</div>
		</div>
	</body>
