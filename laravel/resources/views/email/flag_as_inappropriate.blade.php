		...
		<div class="main-box">
			...
			<div class="changepwsub-box">
				<div class="changepw-body registration-body">
					<p class="favourite-greeting-text"><span class="favourite-greeting-textfirst">Hi {{ $first_name }}!</span><span class=""> This event is mark as </span></p>
				...
				<div class="changepw-footer">
					<a href="{{ route('frontend_more_event',['q'=>$data['event_id']]) }}"><button type="button" class="mailer-forgetpw-btn">View more details</button></a>
				</div>
			</div>
		</div>
	</body>
