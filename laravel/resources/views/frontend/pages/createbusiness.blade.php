				...
				<div class="text-center profileform">
				 	<form>
				 		<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 form-group profilegroup createeventgroup">
		      				<label for="eventname">BUSINESS NAME</label>
		    			...
		    			<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 form-group profilegroup createeventgroup">
		      				...
		      				<div class="categoryselect">
						      	<select class="form-control categorydropdown">
						      		<option selected="selected" class="selectcat">Select Category of Business</option>
		    			...
		    			<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 form-group profilegroup createeventgroup">
		    				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 createeventsectiondiv">
			      				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 createeventcostdiv">
				      				<label for="eventcost">BUSINESS COST</label>
		      				...
		      				<div class="form-group operationgroup">
		      					<div class="col-md-12 form-inline operationform">
		      						<div class="col-md-4 day">
			      						<label for="venue">Mon</label>
			      					</div>
			      					<div class="col-md-8 daylist">
				      					<input type="text" id="" name="monday" class="form-control operationformcontrol">
				      					<select class="form-control operationformcontrol">
									      	<option selected="selected" class="selectcat">AM</option>
									      	<option value="city2">PM</option>
										</select>
										<span>to</span>
				      					<input type="text" id="" name="monday" class="form-control operationformcontrol">
				      					<select class="form-control operationformcontrol operationcontrolselect">
									      	<option selected="selected" class="selectcat">AM</option>
									      	<option value="city2">PM</option>
										</select>
									</div>
