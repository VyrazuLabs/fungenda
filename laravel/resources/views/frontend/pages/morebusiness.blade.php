						...
						<div class="col-md-6 col-sm-6 col-xs-12 customleftsharediv">
							<div class="col-md-12 col-xs-12">
								...
								<div class="shareattendicon eventmoreshareicon">
									...
									<a data-document="{{ $data['business_title'] }}"
									data-link="{{ url('/morebusiness?q=').$data['business_id'] }}" href="javascript:void(0);" class="btn btn-social-icon btn-facebook facebook" class="hamBtn fbH" target="_blank" id="fbbtm"><i class="fa fa-facebook"></i></a>
