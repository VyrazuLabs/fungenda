...
Route::get('/password/changing/{id}/{email}', 'User\AuthController@changeForgetPassword');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    //Members Homepage section
    Route::get('/members-home-page', 'User\MemberHomePageController@viewMembersHomePage')->name('members_home_page');
