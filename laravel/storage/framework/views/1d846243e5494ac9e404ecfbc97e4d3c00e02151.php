		...
		<div class="main-box">
			...
			<div class="changepwsub-box">
				<div class="changepw-body registration-body">
					...
					<p class="chnage-business-subtext">created this business</p>
				</div>
				...
				<div class="changepw-footer">
					<a href="<?php echo e(route('frontend_more_business',['q'=>$data['business_id']])); ?>"><button type="button" class="mailer-forgetpw-btn">View update details</button></a>
				</div>
			</div>
		</div>
	</body>
