		...
		<div class="main-box">
			...
			<div class="changepwsub-box">
				<div class="changepw-body registration-body">
					<p class="favourite-greeting-text"><span class="favourite-greeting-textfirst">Hi <?php echo e($first_name); ?>!</span><span class=""> you have successfully added this business to your favorite list</span></p>
				...
				<div class="mailer-fabourite-box-div">
					...
					<div class="favourite-image-description-box">
						...
						<p class="image-description-text">
							<?php if(mb_strlen($data['business_description']) > 150): ?>
	        					<?php  echo substr($data['business_description'],0,150);  ?> ...
	    					<?php else: ?>
	    						<?php echo e($data['business_description']); ?>
				...
				<div class="changepw-footer">
					<a href="<?php echo e(route('frontend_more_business',['q'=>$data['business_id']])); ?>"><button type="button" class="mailer-forgetpw-btn">Go to my business</button></a>
				</div>
			</div>
		</div>
	</body>
