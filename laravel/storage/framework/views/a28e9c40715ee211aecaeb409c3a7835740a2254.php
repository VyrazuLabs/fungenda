								...
								<?php else: ?>
									...
									<?php if(isset($all_search_business)): ?>
										<div class="businessmain businessevent">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 devide hidelist">
												...
												<?php if(!empty($business[0]['business_main_image'])): ?>
													<?php if(file_exists(public_path().'/'.'images'.'/'.'business'.'/'.$business[0]['business_main_image']) == 1): ?>
													<a href="<?php echo e(route('frontend_more_business',['q'=>$business[0]['business_id']])); ?>">
														...
														<?php endif; ?>
														<img src="<?php echo e(url('/images/business/'.$business[0]['business_main_image'])); ?>" class="img-responsive thumb-img placeholder">
													</a>
									...
									<?php if(isset($all_search_events)): ?>
										<div class="eventmain businessevent">
											...
											<?php if(!empty($event[0]['event_main_image'])): ?>
												<?php if(file_exists(public_path().'/'.'images'.'/'.'event'.'/'.$event[0]['event_main_image']) == 1): ?>
													...
													<a href="<?php echo e(route('frontend_more_event',['q'=>$event[0]['event_id']])); ?>">
														...
														<?php endif; ?>
														<img src="<?php echo e(url('/images/event/'.$event[0]['event_main_image'])); ?>" class="img-responsive thumb-img placeholder">
													</a>
