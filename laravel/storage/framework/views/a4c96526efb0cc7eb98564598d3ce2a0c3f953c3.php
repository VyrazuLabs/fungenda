								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 accountdropddwnclass">
									...
									<div class="select">
										<?php if(isset($business['respected_states'])): ?>
			                              <?php echo e(Form::select('state',$business['respected_states'], null,[ 'id' => 'state', 'class'=>'stateblock', 'placeholder'=>'--select--' ] )); ?>

			                            <?php else: ?>
			                            <?php echo e(Form::select('state',$all_states, null,[ 'id' => 'state','class'=>'stateblock', 'placeholder'=>'--select--'] )); ?>
				    		...
				    		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 accountdropdowngroup">
					      		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 accountdropddwnclass">
						      		...
						      		<div class="select">
			                              ...
			                              <?php echo e(Form::select('city',$business['respected_city'], null,[ 'id' => 'citydropdown','class'=>'citydropdown', 'placeholder'=>'--select--' ] )); ?>

			                            <?php else: ?>
			                            <?php echo e(Form::select('city',[], null,[ 'id' => 'citydropdown','class'=>'citydropdown', 'placeholder'=>'--select--' ] )); ?>
