		...
		<div class="main-box">
			...
			<div class="changepwsub-box">
				<div class="changepw-body">
					<p class="chnage-greeting-text">Hi <?php echo e($first_name); ?> <?php echo e($last_name); ?>,</p>
					<p class="newpass">Your new password is<span class="passno"><a href="<?php echo e(url('/password/changing/')."/".$uniqueid."/".Crypt::encrypt($email)); ?>"> 'link for new password'</a></span></p>
