...
<body class="hold-transition login-page">
		<div class="login-box">
		  ...
		  <div class="login-box-body admin-login-box">
		    <?php echo e(Form::open(['method'=>'post','route'=>'checkLogin'])); ?>

		    	<div class="form-group has-feedback">
		    	<?php echo e(Form::label('useremail','Email')); ?>

		    	<?php echo e(Form::email('useremail',null,['class'=>'form-control createcategory-input','id'=>'userid','placeholder'=>'Enter Your Username'])); ?>

		    	<?php if($errors->has('useremail')): ?>
                    <span id="eventnameerror" class="help-block">
                        <span class="signup-error"><?php echo e($errors->first('useremail')); ?></span>
                    </span>
                <?php endif; ?>
		      ...
		      <div class="form-group has-feedback">
				...
				<?php echo e(Form::password('password',['class'=>'form-control createcategory-input','id'=>'password','placeholder'=>'Enter Your Password'])); ?>
		    ...
		    <!-- /.social-auth-links -->
			<a href="<?php echo e(route('admin_forget_password')); ?>" id="forgotPw" class="forgotpw">I forgot my password</a><br>
		  </div>
		  <!-- /.login-box-body -->
		</div>
<!-- /.login-box -->
